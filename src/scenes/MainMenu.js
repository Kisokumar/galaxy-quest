...
export default class MainMenu extends Base {
  ...
  create() {
    ...
    this.comingSoon = this.add
      .text(screenCenterX, screenCenterY + 335, "Coming soon. . .")
      .setFont(" Verdana, Audiowide")
      .setFontSize(20)
      .setTint(0xff0fff, 0x9effff, 0xff0fff, 0x9effff)
      .setResolution(8)
    ...
    // this.rocket2.turnTimer = 0;
    // this.rocket2.speedDemo = this.rngBase(30, 200);
    // this.rocket2.speedDemo = 180;
    if (this.rngBase(1, 10) % 2 === 0) {
      this.rocket1.direction = "left";
      this.rocket1.right = "small";
      this.rocket1.left = "big";
      // this.rocket2.direction = "right";
    } else {
      this.rocket1.direction = "right";
      this.rocket1.right = "big";
      this.rocket1.left = "small";
      // this.rocket2.direction = "left";
    }
    // this.rocket2.right = "big";
    // this.rocket2.left = "small";
  }
  update() {
